...
<StyledLayerDescriptor version="1.0.0"
   ...
   <Name>Matrikkelen:AnleggsppunktWFS</Name>
   <Title>MatrikkelWFS Anleggsppunkt Layer</Title>
   <Abstract>Punkt for Anleggsprojeksjonspunkt.</Abstract>
   <NamedLayer>
      <Name>Style for Anleggsprojeksjonspunkt</Name>
      <UserStyle>
         <Name>Style for Anleggsprojeksjonspunkt</Name>
         <FeatureTypeStyle>
            <FeatureTypeName>ANLEGGSPPUNKTWFS</FeatureTypeName>
            <!--Nøyaktighet <= 10 cm OG målemetode ikke lik IngenVerdi (62)-->
            <Rule>
               <Title>Anleggsprojeksjonspunkter med nøyaktighet bedre enn 10cm og ukjent målemetode</Title>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter med nøyaktighet mellom 10 og 30 cm og ukjent målemetode</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <And>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter med nøyaktighet mellom 30 og 200 cm og ukjent målemetode</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <And>
                     <PropertyIsGreaterThan>
                        <PropertyName xmlns="http://www.opengis.net/ogc">NOYAKTIGHET</PropertyName>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter med nøyaktighet mellom 200 og 500 cm og ukjent målemetode</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <And>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter med nøyaktighet dårligere enn 500 cm og frihånd eller ukjent målemetode</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <Or>
                     <And>
                        <PropertyIsGreaterThanOrEqualTo>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter med nøyaktighet dårligere enn 500 cm og annen målemetode enn frihånd og ukjent</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <And>
                     <PropertyIsGreaterThanOrEqualTo>
                        <PropertyName xmlns="http://www.opengis.net/ogc">NOYAKTIGHET</PropertyName>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter av type riksgrensemerke, grensestein eller stein med kors </Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <Or>
                     <PropertyIsEqualTo>
            ...
            <!--Bolt [4, 4052]-->
            <Rule>
               <Title>Anleggsprojeksjonspunkter av type bolt </Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <PropertyIsEqualTo>
                     <PropertyName xmlns="http://www.opengis.net/ogc">GRENSEPUNKTTYPE</PropertyName>
            ...
            <!--Kors [5, 4053]-->
            <Rule>
               <Title>Anleggsprojeksjonspunkter av type kors </Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <PropertyIsEqualTo>
                     <PropertyName xmlns="http://www.opengis.net/ogc">GRENSEPUNKTTYPE</PropertyName>
            ...
            <!--OffGodkjent [3, 4051]-->
            <Rule>
               <Title>Anleggsprojeksjonspunkter av type offentlig godkjent grensemerke</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <PropertyIsEqualTo>
                     <PropertyName xmlns="http://www.opengis.net/ogc">GRENSEPUNKTTYPE</PropertyName>
            ...
            <!--Litenprikk -->
            <Rule>
               <Title>Anleggsprojeksjonspunkter av type annen detalj, midt eller djupålen i elv eller bekk eller umerket</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <And>
                     <PropertyIsGreaterThan>
                        <PropertyName xmlns="http://www.opengis.net/ogc">GRENSEPUNKTTYPE</PropertyName>
            ...
            <Rule>
               <Title>Anleggsprojeksjonspunkter med generell opptegning basert på type</Title>
               <Filter xmlns="http://www.opengis.net/ogc">
                  <Or>
                     <PropertyIsEqualTo>
                        <PropertyName xmlns="http://www.opengis.net/ogc">GRENSEPUNKTTYPE</PropertyName>
