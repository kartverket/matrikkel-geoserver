...
<StyledLayerDescriptor version="1.0.0"
   ...
   <NamedLayer>
      <Name>Matrikkelen:GrunnkretsWFS</Name>
      <UserStyle>
         <Name>Style for Grunnkretser</Name>
         <FeatureTypeStyle>
            <FeatureTypeName>GrunnkretsWFS</FeatureTypeName>

            <Rule>
               <Title>Grunnkrets</Title>
               <PolygonSymbolizer>
                  <Geometry>
                  ...
                  <Stroke>
                     <!-- TODO: Riktig farge -->
                     <CssParameter name="stroke">#B4B4FF</CssParameter>
               ...
               <PointSymbolizer>
                  ...
                  <Graphic>
                     <Mark>
                        ...
                        <Fill>
                           <CssParameter name="fill">#B4B4FF</CssParameter>
                        </Fill>
                     </Mark>
                     <Size>8.0</Size>
                  </Graphic>
