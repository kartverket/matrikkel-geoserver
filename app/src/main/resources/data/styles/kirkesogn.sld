...
<StyledLayerDescriptor version="1.0.0"
   ...
   <NamedLayer>
      <Name>Matrikkelen:KirkesognWFS</Name>
      <UserStyle>
         <Name>Style for Kirkesogn</Name>
         <FeatureTypeStyle>
            <FeatureTypeName>KirkesognWFS</FeatureTypeName>

            <Rule>
               <Title>Kirkesogn</Title>
               <PolygonSymbolizer>
                  <Geometry>
                  ...
                  <Label>
                     <Function name="if_then_else">
                        <Function name="isNull">
                           <PropertyName xmlns="http://www.opengis.net/ogc">BISPEDOMME</PropertyName>
                        </Function>
                        <Literal></Literal>
                        <Function name="numberFormat">
                           <Literal xmlns="http://www.opengis.net/ogc">00</Literal>
                           <PropertyName xmlns="http://www.opengis.net/ogc">BISPEDOMME</PropertyName>
                        </Function>
                     </Function><Function name="if_then_else">
                        <Function name="isNull">
                           <PropertyName xmlns="http://www.opengis.net/ogc">PROSTI</PropertyName>
                        </Function>
                        <Literal></Literal>
                        <Function name="numberFormat">
                           <Literal xmlns="http://www.opengis.net/ogc">00</Literal>
                        ...
                        <Function name="isNull">
                           <PropertyName xmlns="http://www.opengis.net/ogc">PRESTEGJELD</PropertyName>
                        </Function>
                        <Literal></Literal>
                        <Function name="numberFormat">
                           <Literal xmlns="http://www.opengis.net/ogc">00</Literal>
